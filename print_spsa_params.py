...
def print_ft_biases(model, condition=lambda value: True):
    c_end = 16
...
def print_l1_weights(model, condition=lambda value: True):
    c_end = 6
    for i in range(8):
        for j in range(16):
            for k in range(3072):
...
def print_l2_weights(model, condition=lambda value: True):
    c_end = 6
    for i in range(8):
        for j in range(32):
            for k in range(30):
